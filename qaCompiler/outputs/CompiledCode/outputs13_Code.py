...
def refreshwebpa22ge_step (browser, loop = False):
	return refreshwebpa22ge_step1(browser, loop)

def refreshwebpa22ge_step1(browser, loop = False):
	browser.reload()
...
def step2(browser, loop = False):
	...
	if browser.find_by_id("masthead-search-term").first.value != 'wololo':
		return "2"
...
def step10(browser, loop = False):
	browser.find_by_id("masthead-search-term").first.type("6")
